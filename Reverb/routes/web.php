...
Route::middleware('auth')->group(function () {
    ...
    Route::post('/blog/{blog}/comment', [ProfileController::class, 'storeComment'])->name('comment.store');
});
...
Route::get('/blog/{blog}', [ProfileController::class, 'showBlog'])->name('blog.show');
